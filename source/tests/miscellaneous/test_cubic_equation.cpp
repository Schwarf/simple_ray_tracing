...
{
	c_vector<4, float> coefficients{a1_, b1_, c1_, d1_};
...
{
	c_vector<4, float> coefficients{a2_, b2_, c2_, d2_};
	auto solver = CubicEquation<float>(coefficients, epsilon_);
...
{
	c_vector<4, float> coefficients{a3_, b3_, c3_, d3_};
	auto solver = CubicEquation<float>(coefficients, epsilon_);
	EXPECT_EQ(solver.number_of_solutions(), 3);
...
{
	c_vector<4, float> coefficients{a4_, b4_, c4_, d4_};
	auto solver = CubicEquation<float>(coefficients, epsilon_);
	EXPECT_EQ(solver.number_of_solutions(), 1);
...
{
	c_vector<4, float> coefficients{a5_, b5_, c5_, d5_};
	auto solver = CubicEquation<float>(coefficients, epsilon_);
	EXPECT_EQ(solver.number_of_solutions(), 3);
...
{
	c_vector<4, float> coefficients{a6_, b6_, c6_, d6_};
	auto solver = CubicEquation<float>(coefficients, epsilon_);
	EXPECT_EQ(solver.number_of_solutions(), 3);
...
{
	c_vector<4, float> coefficients{a7_, b7_, c7_, d7_};
