...
{
	FixedSizedArray<3, double> coefficients{a1_, b1_, c1_};
...
{
	FixedSizedArray<3, double> coefficients{a2_, b2_, c2_};
	auto solver = QuadraticEquation<double>(coefficients, epsilon_);
...
{
	FixedSizedArray<3, double> coefficients{a3_, b3_, c3_};
...
{
	FixedSizedArray<3, double> coefficients{a4_, b4_, c4_};
	auto solver = QuadraticEquation<double>(coefficients, epsilon_);
	EXPECT_EQ(solver.number_of_solutions(), 2);
...
{
	FixedSizedArray<3, double> coefficients{a5_, b5_, c5_};
	auto solver = QuadraticEquation<double>(coefficients, epsilon_);
	EXPECT_EQ(solver.number_of_solutions(), 2);
