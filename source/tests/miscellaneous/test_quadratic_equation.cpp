...
{
	c_vector<3, double> coefficients{a1_, b1_, c1_};
...
{
	c_vector<3, double> coefficients{a2_, b2_, c2_};
	auto solver = QuadraticEquation<double>(coefficients, epsilon_);
...
{
	c_vector<3, double> coefficients{a3_, b3_, c3_};
...
{
	c_vector<3, double> coefficients{a4_, b4_, c4_};
	auto solver = QuadraticEquation<double>(coefficients, epsilon_);
	EXPECT_EQ(solver.number_of_solutions(), 2);
...
{
	c_vector<3, double> coefficients{a5_, b5_, c5_};
	auto solver = QuadraticEquation<double>(coefficients, epsilon_);
	EXPECT_EQ(solver.number_of_solutions(), 2);
